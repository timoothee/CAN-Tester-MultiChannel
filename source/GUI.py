...
class CANGui():
    def __init__(self, gui_revision: str):
        ...
        self.view.add_command(label="Vertical", command=self.vertical_view, state=DISABLED)
        self.view.add_command(label="Horizontal", command = self.horizontal_view, state=DISABLED)
    ...
    def horizontal_view(self):
        ...
        self.can_frame5.grid(row=6, column=0, sticky="nsew")
        self.can_frame6.grid(row=2, column=1, sticky="nsew")
        self.can_frame7.grid(row=3, column=1, sticky="nsew")
        self.can_frame8.grid(row=7, column=0, sticky="nsew")
        self.can_frame8_1.grid(row=0, column=0, sticky="nsew")
        self.can_frame8_2.grid(row=0, column=1, sticky="nsew")
